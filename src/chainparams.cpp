...
{
    const char* pszTimestamp = "Yup, we did it. It's the birth of Bitdeal";
    const CScript genesisOutputScript = CScript() << ParseHex("898984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1317972665, 2084524493, 0x1e0ffff0, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.bitdeal.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("bitdealtools.com", "dnsseed.bitdealtools.com"));
        vSeeds.push_back(CDNSSeedData("bitdealpool.org", "dnsseed.bitdealpool.org"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 293345, 0x1e0ffff0, 1, 500 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        vSeeds.push_back(CDNSSeedData("bitdealtools.com", "testnet-seed.bitdealtools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.bitdeal.loshan.co.uk", true));

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitdeal-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitdeal-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitdeal transaction") + "\n" +
              "  bitdeal-tx [options] -create [commands]   " + _("Create hex-encoded bitdeal transaction") + "\n" +
              "\n";

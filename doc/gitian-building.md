...
Output from `gbuild` will look something like
    ...
    From https://github.com/bitdeal-project/bitdeal
...
[gitian.sigs.ltc](https://github.com/bitdeal-project/gitian.sigs.ltc/) repository, or if that's not possible create a pull

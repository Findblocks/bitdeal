...
- Detached signatures will then be committed to the [bitdeal-detached-sigs](https://github.com/bitdeal/bitdeal-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the bitdeal.co server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the bitdeal.co server.

- Update bitdeal.co version
